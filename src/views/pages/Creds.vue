        ...
        <div class="h-full flex flex-col gap-y-2 md:gap-y-10 px-10">
            <div class="flex flex-col gap-y-5">
                <div class="flex flex-col leading-tight gap-y-[13px] text-slate-200">
                    <div class="text-[37px] uppercase md:text-[45px] font-bold text-pretty tracking-tighter leading-9 lg:leading-11" style="font-family: 'Poppins', sans-serif;">{{utils.devName}}</div>
